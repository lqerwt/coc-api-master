...
import com.lin.cocapibackend.model.dto.userInterfaceInfo.UserInterfaceInfoAddRequest;
import com.lin.cocapibackend.model.dto.userInterfaceInfo.UserInterfaceInfoQueryRequest;
import com.lin.cocapibackend.model.dto.userInterfaceInfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    /**
     * 获取列表（仅管理员可使用）
     * @param userInterfaceInfoQueryRequest 用户请求接口
     * @return
     */
    @AuthCheck(mustRole = UserConstant.ADMIN_ROLE)
    @GetMapping("/list")
     ...
     * 分页获取列表（封装类）
     *
     * @param userInterfaceInfoQueryRequest 用户请求体
     * @param request
     * @return
     */
